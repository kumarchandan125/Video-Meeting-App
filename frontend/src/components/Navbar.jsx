        ...
        <header className='w-full max-w-305 mx-auto bg-white/90 backdrop-blur xl:rounded-b-xl sticky top-0 z-40 px-6 py-4 flex items-center justify-between border border-slate-200'>
            ...
            {isSignedIn && (
                <div className='flex items-center gap-4'>
                    <Link to="/sessions" className='md:hidden text-xs font-medium text-slate-600 hover:text-primary
                     flex items-center gap-1'>
                        <HistoryIcon className='w-4 h-4' />
                        Sessions
                    </Link>
                    <span className='font-medium sm:inline tracking-wide text-sm text-slate-700 hidden'>Welcome, {userName} </span>
