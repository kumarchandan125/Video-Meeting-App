            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
              ...
              >
                ...
                <button
                  ...
                  text-white font-medium px-6 py-3.5 rounded-full transition-all flex items-center justify-center cursor-pointer shadow-xs "
                >
                  <span>Join</span>
